...
var  blogImage = jQuery('#blog').data('background-image');
var  productImage = jQuery('#product').data('background-image');
...
if (blogImage) {  jQuery('#blog').css({ 'background-image':'url(' + blogImage + ')' }); };
if (productImage) {  jQuery('#product').css({ 'background-image':'url(' + productImage + ')' }); };
...
jQuery(document).ready(function($) {
    ...
    $('.next-section .go-to-blog').click(function() {
      $('html,body').animate({scrollTop:$('#blog').offset().top}, 1000);
    });
     $('.next-section .go-to-product').click(function() {
